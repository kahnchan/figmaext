...
function App() {
    ...
    return ((0,jsx_runtime.jsxs)("div", { className: "container", children: [(0,jsx_runtime.jsxs)("div", { className: "header", children: [(0,jsx_runtime.jsx)("div", { className: "title", children: "OneKey \u00B7 PRD Sync" }), (0,jsx_runtime.jsxs)("div", { className: "headerRight", children: [(0,jsx_runtime.jsxs)("div", { className: "tabs", children: [(0,jsx_runtime.jsx)("button", { className: `tabBtn ${mode === 'prd' ? 'tabBtnActive' : ''}`, onClick: () => {
                                        ...
                                        }, children: "Tracker" })] }), (0,jsx_runtime.jsx)("button", { className: `iconBtn ${!hasApiKey ? 'iconBtnWarn' : ''}`, onClick: () => setShowSettings(true), title: "Settings", children: "\u2699" })] })] }), !hasApiKey && ((0,jsx_runtime.jsxs)("div", { className: "banner bannerWarn", children: ["\u8BF7\u5148\u8BBE\u7F6E OpenRouter API Key ", (0,jsx_runtime.jsx)("button", { className: "linkBtn", onClick: () => setShowSettings(true), children: "\u6253\u5F00\u8BBE\u7F6E" })] })), mode === 'prd' ? ((0,jsx_runtime.jsx)(PRDSyncView, { context: context, result: prdResult, autoSync: autoSync, onToggleAutoSync: (v) => {
                    setAutoSync(v);
